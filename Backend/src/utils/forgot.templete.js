...
export const forgotPasswordTemplate = (fullname, link) => {
  ...
  const supportEmail = process.env.SENDER_EMAIL || "support@expensetracker.com";
          ...
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 6px rgba(0,0,0,0.08);">
            ...
            <tr>
              <td style="padding:20px 24px;text-align:center;background:#ffffff;">
                <h1 style="margin:0;font-size:22px;font-weight:600;color:#111827;">Expense Tracker</h1>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:28px 24px 20px;color:#374151;">
                ...
                <p style="margin:0;font-size:14px;line-height:1.5;color:#6b7280;">
                  If you didn't request a password reset, you can safely ignore this email or <a href="mailto:${supportEmail}" style="color:#0366d6;text-decoration:underline;">contact support</a>.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:18px 24px;background:#f8fafc;color:#9ca3af;font-size:13px;text-align:center;">
                <div style="margin-bottom:8px;">Thanks, <strong>Expense Tracker</strong></div>
                <div style="color:#9ca3af">If you need help, email <a href="mailto:${supportEmail}" style="color:#9ca3af;text-decoration:underline;">${supportEmail}</a></div>
